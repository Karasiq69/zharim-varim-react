...
# SECRET_KEY = 'django-insecure-em6y++uo^jebck5g#@i)hzxhnz3b6rys#v*$7+cer*4g07ayx3'
SECRET_KEY = getenv('DJANGO_SECRET_KEY', get_random_secret_key())
# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = True
DEVELOPMENT_MODE = os.getenv("DEVELOPMENT_MODE", "False")=="True"

# ALLOWED_HOSTS = os.getenv('DJANGO_ALLOWED_HOSTS','127.0.0.1,localhost,1ed0-2a02-e0-6a1d-8200-c80e-12b4-125d-b323.ngrok-free.app').split(',')
ALLOWED_HOSTS = ['*']
...
SOCIAL_AUTH_VK_KEY = getenv('VK_AUTH_KEY')
SOCIAL_AUTH_VK_SECRET = getenv('VK_AUTH_SECRET_KEY')
